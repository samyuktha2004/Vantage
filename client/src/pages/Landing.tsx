...
import { ArrowRight, Plane, Hotel, Users, Calendar, QrCode, FileSpreadsheet, Zap, ClipboardList, UserCheck } from "lucide-react";
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Hero */}
      <section className="relative pt-16 pb-12 sm:pt-20 sm:pb-16 md:pt-28 md:pb-24 px-4 sm:px-6 overflow-hidden">
        {/* Background blobs */}
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            TBO Hackathon 2026 — Group Travel Innovation
          </motion.div>
      ...
      {/* Features */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-white/50 backdrop-blur-sm border-t border-border/50">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {workflowSteps.map((item, idx) => (
              <motion.div
                key={item.step}
                className="rounded-2xl bg-white border border-border/50 p-6 shadow-sm"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: idx * 0.1 }}
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="w-10 h-10 rounded-xl bg-secondary/60 text-primary flex items-center justify-center">
